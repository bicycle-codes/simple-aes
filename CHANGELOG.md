...
## [v0.0.16](https://github.com/bicycle-codes/simple-aes/compare/v0.0.15...v0.0.16)

Allow people to use this in any browser, even without a `webcrypto` api, by exposing `compat` module.
